function MenuState(name) {
	...
	btns.push(new MenuButton("Contact", 20, _yPos+210, function() {
		window.open("https://www.linkedin.com/in/pablo-benjumea-49239512a/");
	}));
...
function AboutState(name) {
	...
	var text = "Tic-tac-toe is a ( Circle and Crosses, Os and Xs) is a game for two players, X and O, who take turns marking the spaces in a 3×3 grid. The player who succeeds in placing three respective marks in a horizontal, vertical, or diagonal row wins the game.";
	var hastick = false;
